...
namespace Site_Pessoal.Controllers
{
    public class MensagemsController : Controller
    {
        ...
        public MensagemsController(Site_PessoalContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MensagemId,Nome,Email,Assunto,MensagemT")] Mensagem mensagem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MensagemId,Nome,Email,Assunto,MensagemT")] Mensagem mensagem)
        {
